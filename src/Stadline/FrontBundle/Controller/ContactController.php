...
use Stadline\FrontBundle\Form\ContactType;
...
class ContactController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('StadlineFrontBundle:Contact')->findAll();

        return $this->render('StadlineFrontBundle:Contact:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('StadlineFrontBundle:Contact')->find($id);
        ...
        return $this->render('StadlineFrontBundle:Contact:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('StadlineFrontBundle:Contact:edit.html.twig', array(
            'entity'      => $entity,
